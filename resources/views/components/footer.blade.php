<footer class="bg-primary-950 text-background">
    <div class="mx-auto flex max-w-7xl flex-col gap-10 px-6 py-14 sm:px-8 md:flex-row md:justify-between md:gap-16">
        <div>
        ...
        <div class="min-w-52">
            <h3 class="text-2xl font-bold">Tautan Terkait</h3>
            <div class="mt-5 flex flex-col gap-2 text-sm text-background/75 sm:text-base">
                <a class="transition hover:text-background" href="#">Addons Terbaru</a>
                <a class="transition hover:text-background" href="#">Addons Lainnya</a>
                <a class="transition hover:text-background" href="#">Hubungi Kami</a>
            </div>
        </div>
    </div>
</footer>
